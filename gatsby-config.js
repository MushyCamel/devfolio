    ...
    skills: [
      {
        ...
        description:
          ...
          <br>'- Exceptional verbal, written, and interpersonal communication skills.'</br>+
          <br>'- Expertise in common Production methodologies (eg. Agile, Waterfall) as well as software (Monday, ShotGrid, Excel, Microsoft Project, Confluence, and in-house software).'</br>+
          <br>'- Proven experience in a production role where I have supported cross-functional teams in the creation and delivery of sophisticated projects.'</br>+
          <br>'- Excellent organizational & prioritization skills, attention to detail, process knowledge and ability to multi-task.'</br>,
      },
      {
        name: 'Design',
